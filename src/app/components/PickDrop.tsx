    ...
    <div>
      ...
      <div className="mb-6">
        ...
        <div className="flex flex-col-3 justify-between">
          <DropdownField label="Locations" value="Karachi" disabled />
          <DropdownField label="Date" value="25 april 2024" disabled />
          <DropdownField label="Time" value="09.00" disabled />
        </div>
      </div>
      ...
      <div>
        ...
        <div className="flex flex-col-3 justify-between">
          <DropdownField label="Locations" value="Karachi" disabled />
          <DropdownField label="Date" value="26 april 2024" disabled />
          <DropdownField label="Time" value="04.00" disabled />
        </div>
      </div>
    </div>
  );
